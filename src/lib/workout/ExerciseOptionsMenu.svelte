<script lang="ts">
	...
	/**
	 * What can be done to an exercise in this session: swapped for another, or
	 * taken out of it.
	 *
	 ...
	 *
	 * Both destroy every set under the exercise, so both go through a confirm
	 * once any of them is logged: that is the only data this screen holds, and
	 * there is no undo anywhere in the app. Untouched, neither asks — the loop
	 * does not stop for a decision that costs nothing.
	 *
